...
module "webserver" {
  source  = "app.terraform.io/lab_org_rpt/webserver/azurerm"
  version = "0.12.0"
...
module "appserver" {
  source  = "app.terraform.io/lab_org_rpt/appserver/azurerm"
  version = "0.12.0"
...
module "dataserver" {
  source  = "app.terraform.io/lab_org_rpt/dataserver/azurerm"
  version = "0.12.0"
